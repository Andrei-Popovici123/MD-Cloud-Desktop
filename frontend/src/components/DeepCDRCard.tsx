      ...
      headerRight={
        <div className="flex items-center space-x-2">
          {disableDownload ? (
            <button
              disabled
              className="px-4 py-2 text-sm font-medium rounded-lg focus:outline-none bg-gray-500 text-white cursor-not-allowed"
            >
              Download Sanitized Version
            </button>
          ) : (
            <a href={downloadLink} target="_blank" rel="noopener noreferrer">
              <button className="px-4 py-2 text-sm font-medium rounded-lg focus:outline-none bg-gradient-to-r from-blue-500 to-blue-300 hover:from-blue-600 hover:to-blue-400 text-white">
                Download Sanitized Version
              </button>
            </a>
          )}
